...
![image-20210126151751068](js4.assets/image-20210126151751068.png)
...
```
 <script>
            var coworkers = ['네이버카페', '네이버지식인', '네이버쇼핑'];
...
![image-20210126153757139](js4.assets/image-20210126153757139.png)
